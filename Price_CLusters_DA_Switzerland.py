...
# =================================================================
FILE_PATHS = [
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_201512312300-201612312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_201612312300-201712312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_201712312300-201812312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_201812312300-201912312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_201912312300-202012312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_202012312300-202112312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_202112312300-202212312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_202212312300-202312312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_202312312300-202412312300.csv',
    '/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/GUI_ENERGY_PRICES_202412312300-202512312300.csv'
]
N_SCENARIOS = 5
...
def run_stochastic_DAM_clustering_CH():
    all_years_raw_data = []
    year_features = []
    valid_file_names = []
    ...
    output_file = "/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Day Ahead Energy Prices Zurich/Representative_DAM_Price_Scenarios_CH.xlsx"
...
if __name__ == "__main__":
    run_stochastic_DAM_clustering_CH()