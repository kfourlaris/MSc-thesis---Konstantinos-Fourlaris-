...
data.to_csv("/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Zurich_meteo_data_2025.csv", index=True, encoding="utf-8")
...
data.to_csv("/Users/kostf/Library/CloudStorage/OneDrive-Προσωπικό/Έγγραφα/ETH Zurich/4th semester/system-level-optimization/Input data/Amsterdam_meteo_data_2025.csv", index=True, encoding="utf-8")
