...
class PitThermalEnergyStorage:
    def __init__(self, name, e_min_market=50, e_max_market=2788800,
                 capex_per_kwh=5, loss_rate=0.0005, eta_charge=0.9, eta_disch=0.9):
        """
        Args:
    ...
    def add_constraints(self, model, timesteps, hp_instance, peak_demand_kw):
        ...
        for t in timesteps:
            ...
            model.addConstr(self.U_charge[t] <= hp_instance.P_cap * self.C_tech[t], name=f"charging_constraint{self.name}_{t}")
